...
public class MissingQflanCoreJarDialog extends Dialog {
	...
	public MissingQflanCoreJarDialog(Shell parentShell, String link, String linkShort, ArrayList<String> paths, String OS) {
		super(parentShell);
		this.path=link;
	...
	protected Control createDialogArea(Composite parent) {
		...
		//messageLabel.setFont(parent.getFont());
		//messageLabel.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
		messageLabel2.setText("Add the downloaded jar in one of the following locations:");
