...
//		IQFlanModelBuilder bikesBuilder = new BikesWithoutFakeFeatures();
...
//		System.out.println(bikesSPLC);
	...
	public static void test3() throws Z3Exception{
		...
		//Constraints
		ActionRequiresConstraint aRequiresAllYear = new ActionRequiresConstraint(a, new HasFeature(allYear,model));
