...
public class BikesDiagram implements IQFlanModelBuilder{
	...
	public QFlanModel createModel() throws Z3Exception{
		...
		model.addConstraint(new Alternative_OrConstraint(Wheels,Arrays.asList((IFeature)AllYear,(IFeature)Summer,(IFeature)Winter), Alternative_ORCondition.XOR,model));
		model.addConstraint(new Alternative_OrConstraint(Energy,Arrays.asList((IFeature)Dynamo,(IFeature)Battery), Alternative_ORCondition.OR,model));
		model.addConstraint(new Alternative_OrConstraint(Frame,Arrays.asList((IFeature)Diamond,(IFeature)StepThru), Alternative_ORCondition.XOR,model));
		...
		model.addConstraint(new FeatureSetConstraint(Arrays.asList((IFeature)GPS,(IFeature)Diamond), FeatureSetCondition.ATMOSTONE,model));
		...
		model.addProcessDefinition(factory, QFlanModel.makeMultiChoice(Arrays.asList((IProcess)new Prefix(8.0,sell,new SideEffect[]{},deposit), (IProcess)new Prefix(6.0,new InstallAction(GPS,true),new SideEffect[]{},factory), (IProcess)new Prefix(10.0,new InstallAction(MapsApp,true),new SideEffect[]{},factory), (IProcess)new Prefix(6.0,new InstallAction(NaviApp,true),new SideEffect[]{},factory), (IProcess)new Prefix(3.0,new InstallAction(GuideApp,true),new SideEffect[]{},factory), (IProcess)new Prefix(20.0,new InstallAction(Music,true),new SideEffect[]{},factory), (IProcess)new Prefix(4.0,new InstallAction(Engine,true),new SideEffect[]{},factory), (IProcess)new Prefix(4.0,new InstallAction(Battery,true),new SideEffect[]{},factory), (IProcess)new Prefix(10.0,new InstallAction(Dynamo,true),new SideEffect[]{},factory), (IProcess)new Prefix(10.0,new InstallAction(Light,true),new SideEffect[]{},factory), (IProcess)new Prefix(8.0,new InstallAction(Basket,true),new SideEffect[]{},factory), (IProcess)new Prefix(5.0,new ReplaceAction(AllYear,Summer),new SideEffect[]{},factory), (IProcess)new Prefix(5.0,new ReplaceAction(AllYear,Winter),new SideEffect[]{},factory), (IProcess)new Prefix(10.0,new ReplaceAction(Summer,AllYear),new SideEffect[]{},factory), (IProcess)new Prefix(5.0,new ReplaceAction(Summer,Winter),new SideEffect[]{},factory), (IProcess)new Prefix(5.0,new ReplaceAction(Winter,Summer),new SideEffect[]{},factory), (IProcess)new Prefix(10.0,new ReplaceAction(Winter,AllYear),new SideEffect[]{},factory), (IProcess)new Prefix(3.0,new ReplaceAction(Diamond,StepThru),new SideEffect[]{},factory), (IProcess)new Prefix(3.0,new ReplaceAction(StepThru,Diamond),new SideEffect[]{},factory))));
		model.addProcessDefinition(deposit, QFlanModel.makeMultiChoice(Arrays.asList((IProcess)new Prefix(10.0,deploy,new SideEffect[]{new SideEffect(deploys,new ArithmeticPredicateExpr(deploys,new Constant(1.0),ArithmeticOperation.SUM))},parked), (IProcess)new Prefix(6.0,new InstallAction(GPS,true),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new InstallAction(MapsApp,true),new SideEffect[]{},deposit), (IProcess)new Prefix(6.0,new InstallAction(NaviApp,true),new SideEffect[]{},deposit), (IProcess)new Prefix(3.0,new InstallAction(GuideApp,true),new SideEffect[]{},deposit), (IProcess)new Prefix(20.0,new InstallAction(Music,true),new SideEffect[]{},deposit), (IProcess)new Prefix(4.0,new InstallAction(Engine,true),new SideEffect[]{},deposit), (IProcess)new Prefix(4.0,new InstallAction(Battery,true),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new InstallAction(Dynamo,true),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new InstallAction(Light,true),new SideEffect[]{},deposit), (IProcess)new Prefix(8.0,new InstallAction(Basket,true),new SideEffect[]{},deposit), (IProcess)new Prefix(6.0,new InstallAction(GPS,false),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new InstallAction(MapsApp,false),new SideEffect[]{},deposit), (IProcess)new Prefix(6.0,new InstallAction(NaviApp,false),new SideEffect[]{},deposit), (IProcess)new Prefix(3.0,new InstallAction(GuideApp,false),new SideEffect[]{},deposit), (IProcess)new Prefix(20.0,new InstallAction(Music,false),new SideEffect[]{},deposit), (IProcess)new Prefix(1.0,new InstallAction(Engine,false),new SideEffect[]{},deposit), (IProcess)new Prefix(2.0,new InstallAction(Battery,false),new SideEffect[]{},deposit), (IProcess)new Prefix(3.0,new InstallAction(Dynamo,false),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new InstallAction(Light,false),new SideEffect[]{},deposit), (IProcess)new Prefix(8.0,new InstallAction(Basket,false),new SideEffect[]{},deposit), (IProcess)new Prefix(5.0,new ReplaceAction(AllYear,Summer),new SideEffect[]{},deposit), (IProcess)new Prefix(5.0,new ReplaceAction(AllYear,Winter),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new ReplaceAction(Summer,AllYear),new SideEffect[]{},deposit), (IProcess)new Prefix(5.0,new ReplaceAction(Summer,Winter),new SideEffect[]{},deposit), (IProcess)new Prefix(5.0,new ReplaceAction(Winter,Summer),new SideEffect[]{},deposit), (IProcess)new Prefix(10.0,new ReplaceAction(Winter,AllYear),new SideEffect[]{},deposit), (IProcess)new Prefix(1.0,new ReplaceAction(Battery,Dynamo),new SideEffect[]{},deposit))));
		model.addProcessDefinition(parked, QFlanModel.makeMultiChoice(Arrays.asList((IProcess)new Prefix(10.0,book,new SideEffect[]{},moving), (IProcess)new Prefix(1.0,maintain,new SideEffect[]{},deposit))));
		model.addProcessDefinition(moving, QFlanModel.makeMultiChoice(Arrays.asList((IProcess)new Prefix(5.0,stop,new SideEffect[]{},halted), (IProcess)new Prefix(1.0,breakAction,new SideEffect[]{},broken), (IProcess)new Prefix(20.0,Music,new SideEffect[]{},moving), (IProcess)new Prefix(20.0,Light,new SideEffect[]{},moving))));
		model.addProcessDefinition(halted, QFlanModel.makeMultiChoice(Arrays.asList((IProcess)new Prefix(5.0,start,new SideEffect[]{},moving), (IProcess)new Prefix(1.0,breakAction,new SideEffect[]{},broken), (IProcess)new Prefix(20.0,Music,new SideEffect[]{},halted), (IProcess)new Prefix(10.0,GPS,new SideEffect[]{},halted), (IProcess)new Prefix(10.0,GuideApp,new SideEffect[]{},halted), (IProcess)new Prefix(10.0,MapsApp,new SideEffect[]{},halted), (IProcess)new Prefix(10.0,NaviApp,new SideEffect[]{},halted), (IProcess)new Prefix(10.0,Light,new SideEffect[]{},halted))));
		model.addProcessDefinition(broken, QFlanModel.makeMultiChoice(Arrays.asList((IProcess)new Prefix(10.0,assistance,new SideEffect[]{},deposit), (IProcess)new Prefix(1.0,irreparable,new SideEffect[]{new SideEffect(trashed,new Constant(1.0))},ZeroProcess.ZERO))));
